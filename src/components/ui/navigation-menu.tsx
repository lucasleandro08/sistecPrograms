...
// Componente raiz do NavigationMenu, organiza o container e o viewport
...
// Lista de itens do NavigationMenu, usa flex com espaçamento horizontal
...
// Item do menu (sem modificações adicionais)
const NavigationMenuItem = NavigationMenuPrimitive.Item

// Estilos para o trigger do menu, com estados hover, foco e aberto
...
// Trigger do menu, inclui ícone de seta que gira quando aberto
...
// Conteúdo do menu, com animações condicionais e posicionamento responsivo
...
// Link do NavigationMenu (sem modificações adicionais)
const NavigationMenuLink = NavigationMenuPrimitive.Link

// Viewport que exibe o menu aberto, com animações e responsividade
    ...
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border " +
          "bg-popover text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out " +
...
// Indicador visual para o item ativo do menu, com animação e posicionamento
